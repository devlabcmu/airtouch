...
int connectedComponents(Mat &L, const Mat &I, int connectivity){
    ...
    if(lDepth == CV_8U){
        if(iDepth == CV_8U || iDepth == CV_8S){
            if(connectivity == 4){
                return LabelingImpl<UINT8, UINT8, 4>()(L, I);
            }else{
                return LabelingImpl<UINT8, UINT8, 8>()(L, I);
            }
        }else if(iDepth == CV_16U || iDepth == CV_16S){
            if(connectivity == 4){
                return LabelingImpl<UINT8, UINT16, 4>()(L, I);
            }else{
                return LabelingImpl<UINT8, UINT16, 8>()(L, I);
            }
        }else if(iDepth == CV_32S){
            if(connectivity == 4){
                return LabelingImpl<UINT8, INT32, 4>()(L, I);
            }else{
                return LabelingImpl<UINT8, INT32, 8>()(L, I);
            }
        }else if(iDepth == CV_32F){
            if(connectivity == 4){
                return LabelingImpl<UINT8, float, 4>()(L, I);
            }else{
                return LabelingImpl<UINT8, float, 8>()(L, I);
            }
        }else if(iDepth == CV_64F){
            if(connectivity == 4){
                return LabelingImpl<UINT8, double, 4>()(L, I);
            }else{
                return LabelingImpl<UINT8, double, 8>()(L, I);
            }
        }
    }else if(lDepth == CV_16U){
        if(iDepth == CV_8U || iDepth == CV_8S){
            if(connectivity == 4){
                return LabelingImpl<UINT16, UINT8, 4>()(L, I);
            }else{
                return LabelingImpl<UINT16, UINT8, 8>()(L, I);
            }
        }else if(iDepth == CV_16U || iDepth == CV_16S){
            if(connectivity == 4){
                return LabelingImpl<UINT16, UINT16, 4>()(L, I);
            }else{
                return LabelingImpl<UINT16, UINT16, 8>()(L, I);
            }
        }else if(iDepth == CV_32S){
            if(connectivity == 4){
                return LabelingImpl<UINT16, INT32, 4>()(L, I);
            }else{
                return LabelingImpl<UINT16, INT32, 8>()(L, I);
            }
        }else if(iDepth == CV_32F){
            if(connectivity == 4){
                return LabelingImpl<UINT16, float, 4>()(L, I);
            }else{
                return LabelingImpl<UINT16, float, 8>()(L, I);
            }
        }else if(iDepth == CV_64F){
            if(connectivity == 4){
                return LabelingImpl<UINT16, double, 4>()(L, I);
            }else{
                return LabelingImpl<UINT16, double, 8>()(L, I);
            }
        }
    }else if(lDepth == CV_32S){
        if(iDepth == CV_8U || iDepth == CV_8S){
            if(connectivity == 4){
                return LabelingImpl<INT32, UINT8, 4>()(L, I);
            }else{
                return LabelingImpl<INT32, UINT8, 8>()(L, I);
            }
        }else if(iDepth == CV_16U || iDepth == CV_16S){
            if(connectivity == 4){
                return LabelingImpl<INT32, UINT16, 4>()(L, I);
            }else{
                return LabelingImpl<INT32, UINT16, 8>()(L, I);
            }
        }else if(iDepth == CV_32S){
            if(connectivity == 4){
                return LabelingImpl<INT32, INT32, 4>()(L, I);
            }else{
                return LabelingImpl<INT32, INT32, 8>()(L, I);
            }
        }else if(iDepth == CV_32F){
            if(connectivity == 4){
                return LabelingImpl<INT32, float, 4>()(L, I);
            }else{
                return LabelingImpl<INT32, float, 8>()(L, I);
            }
        }else if(iDepth == CV_64F){
            if(connectivity == 4){
                return LabelingImpl<INT32, double, 4>()(L, I);
            }else{
                return LabelingImpl<INT32, double, 8>()(L, I);
            }
        }
    }
